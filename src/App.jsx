  ...
  const [viewDate, setViewDate] = useState(getInitialDate);
    ...
    const timer = setInterval(() => {
      setViewDate(prevDate => {
        ...
        // Päivitetään näkymä vain, jos päivä on oikeasti vaihtunut.
        if (prevDate.toDateString() !== correctDate.toDateString()) {
          return correctDate;
        }
        return prevDate;
      });
    }, 60 * 1000); // Tarkistetaan tilanne kerran minuutissa
